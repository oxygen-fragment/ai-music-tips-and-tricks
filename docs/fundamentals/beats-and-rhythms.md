...
- L "140 BPM trap" (AI might make it too fast)
...
- L "140 BPM trap" � Might give you kick drums at 140 (too fast!)
-  "70 BPM trap with rolling hi-hats"

**Mistake 2: Not specifying the beat pattern**
- L "120 BPM electronic" � Could be house, techno, breakbeat, anything
-  "120 BPM house with four-on-the-floor kick"

**Mistake 3: Assuming genre = tempo**
- L "Trap beat" � Could be 60 BPM, could be 80 BPM
-  "75 BPM trap beat"
